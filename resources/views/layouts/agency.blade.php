            ...
            <ul class="c-header-nav ml-auto align-items-center">
                @auth
                    ...
                    <li class="c-header-nav-item dropdown mr-2">
                        <a class="c-header-nav-link position-relative" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-bell"></i>
                            @if($unreadNotificationsCount > 0)
                                <span class="badge badge-danger" style="position:absolute;top:-2px;right:-8px;">{{ $unreadNotificationsCount }}</span>
                            @endif
                        </a>
                    ...
                    <li class="c-header-nav-item dropdown">
                        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <span class="user-chip">
                                <span class="user-chip__avatar">{{ strtoupper(substr(auth()->user()->name ?? 'U', 0, 1)) }}</span>
